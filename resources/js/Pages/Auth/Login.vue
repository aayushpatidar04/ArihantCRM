        ...
        <div class="relative w-full max-w-sm animate-slide-up">
            ...
            <div class="text-center mb-8">
                ...
                >
                    <img
                        ...
                        alt="InTouch Connect"
                        class="w-20 h-20 rounded-full object-cover absolute border-2 border-white"
                    />
                </div>
            ...
            >
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    <div>
                        <label
                            class="block text-xs font-medium text-surface-300 mb-1.5 text-white"
                            >Email</label
                        >
                        <input
                            v-model="form.email"
                            ...
                            required
                            :class="[
                                'w-full rounded-xl bg-white/10 border text-white placeholder-surface-500 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-400 transition-all',
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            />
                            <span class="text-xs text-surface-400 text-white"
                                >Remember me</span
                            >
                        </label>
                        <a
                            :href="route('password.request')"
                            class="text-xs text-white hover:text-brand-200"
                        >
                            Forgot password?
                        </a>
                    </div>
